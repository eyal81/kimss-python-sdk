...
description: Configure the Kimss MCP server in Cursor or other MCP-capable IDEs using uvx, environment variables, and the seven v1 tools.
---
...
- User asks how to wire Kimss into Cursor, Windsurf, or another MCP client.
...
- **Process exits immediately:** `KIMSS_API_KEY` unset or empty — set env and restart MCP.
...
- [README.md](../../README.md) — Cursor & Windsurf blocks, streaming note.
